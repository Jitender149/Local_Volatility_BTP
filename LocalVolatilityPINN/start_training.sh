#!/bin/bash
# Start Local Volatility PINN training from main folder

SCRIPT_DIR="/home/tanveer/poorpeople/LocalVolatility/LocalVolatilityPINN"
cd "$SCRIPT_DIR"

echo "=== Starting Local Volatility PINN Training ==="
...
nohup /home/tanveer/miniconda3/envs/poorpeople-env-py310/bin/python tf_local_vol_pinn.py > training_output.log 2>&1 &
